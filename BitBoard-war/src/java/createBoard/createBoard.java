...
import RegisterUser.BoardFunctionsRemote;
...
public class createBoard extends HttpServlet {
    @EJB
    private BoardFunctionsRemote boardFunctions;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boardFunctions.addBoard(101, (String) session.getAttribute("theuser"), request.getParameter("compn"), request.getParameter("dname"));
             out.write("\r\n");
      ...
      out.write("                <h2 class=\"red\" align=\"center\">Create a board</h2>\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("            <br>\r\n");
      out.write("            <div class=\"row\">\r\n");
      out.write("            \t<div class=\"register span12\" style=\"background-color:#F2F2F2; border-radius:5px; box-shadow: 0px 0px 2px 1px #888888;text-shadow: 0px 0px 1px; height:100px\">\r\n");
      out.write("                <form action=\"\" method=\"post\">\r\n");
      out.write("                <label for=\"Board Name\">Board Name</label>\r\n");
      out.write("                        <input type=\"text\" id=\"bname\" name=\"bname\" placeholder=\"Enter a board name\">\r\n");
      out.write("                        <label for=\"Company Name\">Company Name</label>\r\n");
      out.write("                        <input type=\"text\" id=\"bname\" name=\"bname\" placeholder=\"Enter a company name\">\r\n");
      out.write("                        <label for=\"Department\">Department</label>\r\n");
      out.write("                        <input type=\"text\" id=\"bname\" name=\"bname\" placeholder=\"Enter the department\">\r\n");
