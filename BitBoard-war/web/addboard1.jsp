    ...
    <body>
        ...
        <div class="register-container container">
            <div class="row">
                ...
                <h2 class="red" align="center">Create a board</h2>
                </div>
            </div>
            <br>
            <div class="row">
            	<div class="register span12" style="background-color:#F2F2F2; border-radius:5px; box-shadow: 0px 0px 2px 1px #888888;text-shadow: 0px 0px 1px; height:100px">
                <form action="" method="post">
                <label for="Board Name">Board Name</label>
                        <input type="text" id="bname" name="bname" placeholder="Enter a board name">
                        <label for="Company Name">Company Name</label>
                        <input type="text" id="bname" name="bname" placeholder="Enter a company name">
                        <label for="Department">Department</label>
                        <input type="text" id="bname" name="bname" placeholder="Enter the department">
